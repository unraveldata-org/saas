...
from saas.cluster_lifecycle_manager.models.cluster_spec_model import ClusterSpecModel
...
cluster_spec = ClusterSpecModel(CloudProvider.NAME.EMR, "test_cluster_2", CLUSTER_TYPE.DEFAULT, STACK_VERSION.LATEST, "alejandro",
...
print("Retrieved cluster: {}".format(cluster))
